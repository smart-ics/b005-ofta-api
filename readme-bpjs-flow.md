...
sequenceDiagram
    ...
    note over kasir, TILAKA: EVENT-C: PRINT DOCUMENT
    ...
    note over kasir, TILAKA: EVENT-F: DOWNLOAD DOCUMENT
    note over OFTA, casemix: F1
    OFTA ->> TILAKA: request download
    TILAKA -->> OFTA : send Doc

    note over kasir, TILAKA: EVENT-G: MERGE DOCYMENT
