...
SELECT 'DTX05',  'Resume Administratif', 1, 1, '', 'printResume','Resume' UNION ALL
...
SELECT 'DTX13',  'Other Doc', 1, 1, '','printOtherDoc','14' UNION ALL
SELECT 'DTX14',  'Resume Medis', 1, 1, '', 'printResume','Resume'
GO
